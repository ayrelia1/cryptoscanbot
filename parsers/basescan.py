...
class Basescan(BaseParser):
    ...
    async def get_html_page(self, address: str) -> str:
        async with self.get_browser() as driver:
            driver.get(f"https://basescan.org/address/{address}#code")
...
if __name__ == '__main__':
    eth = Basescan()
    print(asyncio.run(eth.get_token_info('https://basescan.org/address/0xB5aEBDbf87e3429d6bDF3cedB40A7E3D23F8e200#code')))
